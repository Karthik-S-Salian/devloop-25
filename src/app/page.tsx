...
const Home = () => {
  return (
    <main className="flex flex-col items-center justify-center gap-4 overflow-x-hidden bg-black">
        ...
        <div className="h-auto w-[80vw]">
          ...
          >
            ...
            <ul className="dotted-list my-16 text-lg">
              ...
              <li>
                Solve as many puzzles (referred to as "doors") as possible to
              ...
              <li>
                If you choose to quit a puzzle, the door will "break," meaning
                you can never return to that puzzle again. So, think carefully
                before quitting.
              </li>
              <li>
